...
Begin VB.Form widgetPrefs 
   Caption         =   "UBoat StopWatch Preferences"
   ClientHeight    =   10545
   ClientLeft      =   60
   ClientTop       =   510
   ClientWidth     =   8880
...
Private Sub optGaugeTooltips_Click(Index As Integer)
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzStopWatch", "gaugeTooltips", gblGaugeTooltips, gblSettingsFile
...
Private Sub optPrefsTooltips_Click(Index As Integer)
   ...
   On Error GoTo optPrefsTooltips_Click_Error
    ...
    If pvtPrefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzStopWatch", "prefsTooltips", gblPrefsTooltips, gblSettingsFile
   ...
   On Error GoTo cmbMultiMonitorResize_Click_Error
    ...
    If cmbMultiMonitorResize.ListIndex = 2 Then
        If prefsMonitorStruct.IsPrimary = True Then
            ...
            sPutINISetting "Software\PzStopWatch", "gaugePrimaryHeightRatio", gblGaugePrimaryHeightRatio, gblSettingsFile
            
            'gblPrefsPrimaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzStopWatch", "prefsPrimaryHeightTwips", gblPrefsPrimaryHeightTwips, gblSettingsFile
        Else
            gblGaugeSecondaryHeightRatio = fGauge.gaugeForm.WidgetRoot.Zoom
            sPutINISetting "Software\PzStopWatch", "gaugeSecondaryHeightRatio", gblGaugeSecondaryHeightRatio, gblSettingsFile
            
            'gblPrefsSecondaryHeightTwips = Trim$(cstr(widgetPrefs.Height))
            sPutINISetting "Software\PzStopWatch", "prefsSecondaryHeightTwips", gblPrefsSecondaryHeightTwips, gblSettingsFile
        End If
    End If
...
Public Sub positionPrefsMonitor()
    ...
    If gblMonitorCount > 1 And LTrim$(gblMultiMonitorResize) = "2" Then
        ...
        If prefsMonitorStruct.IsPrimary = True Then
            gblPrefsFormResizedInCode = True
            gblPrefsPrimaryHeightTwips = fGetINISetting("Software\PzStopWatch", "prefsPrimaryHeightTwips", gblSettingsFile)
            ...
            End If
        Else
            gblPrefsSecondaryHeightTwips = fGetINISetting("Software\PzStopWatch", "prefsSecondaryHeightTwips", gblSettingsFile)
            gblPrefsFormResizedInCode = True
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        ...
        sPutINISetting "Software\PzStopWatch", "showHelp", gblShowHelp, gblSettingsFile
        ...
        sPutINISetting "Software\PzStopWatch", "widgetFunctions", gblGaugeFunctions, gblSettingsFile
        ...
        sPutINISetting "Software\PzStopWatch", "gaugeFont", gblGaugeFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzStopWatch", "displayScreenFont", gblDisplayScreenFont, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "displayScreenFontSize", gblDisplayScreenFontSize, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "displayScreenFontItalics", gblDisplayScreenFontItalics, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "displayScreenFontColour", gblDisplayScreenFontColour, gblSettingsFile
        ...
        sPutINISetting "Software\PzStopWatch", "multiMonitorResize", gblMultiMonitorResize, gblSettingsFile
...
'        sPutINISetting "Software\PzStopWatch", "enableTicks", gblEnableTicks, gblSettingsFile
'        sPutINISetting "Software\PzStopWatch", "enableChimes", gblEnableChimes, gblSettingsFile
'        sPutINISetting "Software\PzStopWatch", "enableAlarms", gblEnableAlarms, gblSettingsFile
'        sPutINISetting "Software\PzStopWatch", "volumeBoost", gblVolumeBoost, gblSettingsFile
        ...
        sPutINISetting "Software\PzStopWatch", "defaultVB6Editor", gblDefaultVB6Editor, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "defaultTBEditor", gblDefaultTBEditor, gblSettingsFile
        
        sPutINISetting "Software\PzStopWatch", "gaugeHighDpiXPos", gblGaugeHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "gaugeHighDpiYPos", gblGaugeHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzStopWatch", "gaugeLowDpiXPos", gblGaugeLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzStopWatch", "gaugeLowDpiYPos", gblGaugeLowDpiYPos, gblSettingsFile
